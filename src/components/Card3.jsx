  ...
  return (
    <div className="max-w-sm mt-5 ">
      <div className="relative">
        ...
        <span className="absolute top-4 right-24 bg-white text-gray-800 text-xs px-3 py-1">
          {button}
        </span>

      <div className="p-3 absolute bottom-2 right-20 left-5 border bg-white text-left">
