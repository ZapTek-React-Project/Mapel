...
const Home = () => {
  return (
    <div className="relative h-[100vh]">
      ...
      <div className="my-8 mx-4 lg:mt-28">
        ...
        <div className=" lg:flex ">
          <Card
            image={<img className=" w-80 h-72 lg:w-96 " src="IM1.jpg" alt="home image" />}
            button="For Sale"
            description="Luxury Waterfront Condo"
            cost="$1,250,000"
          />
          <Card
            image={<img className="w-80 h-72 lg:w-96" src="IM2.jpg" alt="home image" />}
            button="For Rent"
            description="Newly Built Family Home"
            cost="$1,750,000"
          />
          <Card
            image={<img className="w-80 h-72 lg:w-96" src="IM3.jpg" alt="home image" />}
            button="For Sale"
      ...
      <div className=" py-7 bg- -bg--background mt-2 lg:flex lg:mt-20 ">
        <div className="px-5">
        ...
        Our mission is to simplify the home-buying experience by providing top-notch <br/> service, trusted guidance, & a 
        diverse range of high-quality properties. 
        We’re <br/> here to help you find a space that truly feels like home.
        </div>
        </div>
        <div>
        <div>
          <div className="hidden lg:block">
          <p className="text-xl font-mono lg:text-4xl">Find Your Dream Home With Mapel</p>
          <p className="text-gray-800">We believe that finding your dream home should<br className="block lg:hidden"/> be a delightful experience. 
            With a <br className="hidden lg:block"/>commitment to<br className="block lg:hidden"/> excellence & a deep understanding of the real<br className="block lg:hidden"/> estate market, 
            we strive <br className="hidden lg:block"/>to simplify the home- <br className="block lg:hidden"/>buying process for our clients</p>
          </div>
          ...
          <p className="text-gray-800">We believe that finding your dream home should<br/> be a delightful experience. 
            With a commitment to <br/> excellence & a deep understanding of the real<br/> estate market, 
            we strive to simplify the home- <br/>buying process for our clients</p>
        </div>
        </div>
      ...
      <div className="my-8 mx-4">
        ...
        <div className="grid grid-cols-2 lg:flex">
          <Card2
            picture={<img className="h-40 w-40 lg:w-60" src="IM5.jpg" alt="a house" />}
            tag="Luxury Rentals"
          />
          <Card2
            picture={<img className="h-40 w-40  lg:w-60" src="IM6.jpg" alt="a house" />}
            tag="City Townhouses"
          />
          <Card2
            picture={<img className="h-40 w-40  lg:w-60" src="IM7.jpg" alt="a house" />}
            tag="Modern Apartments"
          />
          <Card2
            picture={<img className="h-40 w-40  lg:w-60" src="IM8.jpg" alt="a house" />}
            tag="Industrial Spaces"
          />
          <Card2
            picture={<img className="h-40 w-40  lg:w-60" src="IM9.jpg" alt="a house" />}
      ...
      <div className="texts section">
        ...
        <div className="mt-4 grid lg:grid-cols-3 grid-rows-2 gap-2">
        <Card3
        image= {<img className="w-80 h-96 lg:w-full lg:h-full" src="H1.jpg" alt="room" />}
        button='For Sale'
        ...
        />
         <Card3
        image= {<img className="w-80 h-96 lg:w-full lg:h-full" src="H3.jpg" alt="room" />}
        button='For Sale'
        ...
        />
         <Card3
        image= {<img className="w-80 h-96 lg:w-full lg:h-full" src="H2.jpg" alt="room" />}
        button='For Rent'
        ...
        />
         <Card3
        image= {<img className="w-80 h-96 lg:w-full lg:h-full" src="H4.jpg" alt="room" />}
        button='For Sale'
        ...
        />
         <Card3
        image= {<img className="w-80 h-96 lg:w-full lg:h-full" src="H5.jpg" alt="room" />}
        button='For Rent'
        ...
        />
         <Card3
        image= {<img className="w-80 h-96 lg:w-full lg:h-full" src="H6.jpg" alt="room" />}
        button='For Sale'
       ...
       <div>
        ...
        <div className="grid lg:grid-cols-3 grid-rows-3 gap-2">
          ...
          date='Oct 15,2024'
          Description={
            <>Unlocking the real estate market <br/>top strategies for buyers
            </>
            }
            image={<img className="w-80 h-60 lg:w-auto lg:h-auto" src="IMG1.jpg" alt=""/>}
            description={
              <> Discover how to navigate competitive<br/> markets, negotiate prices, and find hidden<br/> gems.
              </>
            }
          />
          <Card6
          date='Oct 15,2024'
          Description={
            <>Building a strong rental portfolio <br/>what you need to know
            </>
            }
            image={<img className="w-80 h-60 lg:w-auto lg:h-auto" src="IMG2.jpg" alt=""/>}
            description={
              <> Explore essential tips for building and<br/> managing a profitable rental property<br/> portfolio.
              </>
            }
          />
          <Card6
          date='Oct 15,2024'
          Description={
            <>Creating curb appeal simple<br/> upgrades for maximum impact
            </>
            }
            image={<img className="w-80 h-60 lg:w-auto lg:h-auto" src="IMG3.jpg" alt=""/>}
            description={
              <>Elevate your home’s exterior appeal with <br/>these easy and effective upgrades.<br/> <br/>
              </>
            }
          />
        </div>
